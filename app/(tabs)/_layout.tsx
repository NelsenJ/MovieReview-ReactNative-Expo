...
export default function RootLayout() {
  const { width } = useWindowDimensions(); // Ambil ukuran layar real-time
  const isSmallScreen = width < 875; // Jika layar < 875px
    ...
    <>
      ...
      <View style={styles.navbar}>
        <View style={styles.navContainer}>
          ...
          {/* Nav Links hanya muncul jika layar >= 875px */}
          {!isSmallScreen && (
          ...
          {/* User Button tetap selalu terlihat */}
